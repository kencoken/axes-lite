...
def index_cpuvisor(base_path, component_cfgs,
    ...
    cpuvisorutil = utils.import_python_module_from_path(os.path.join(component_cfgs['paths']['cpuvisor-srv'], 'utils'),
                                                        'generate_imagelist')
    ...
    dataset_im_paths = os.path.join(component_cfgs['paths']['cpuvisor-srv'],
                                    'server_data',
                                    'dsetpaths_%s.binaryproto' % dataset_name)
    dataset_feats_file = os.path.join(component_cfgs['paths']['cpuvisor-srv'],
                                      'server_data',
